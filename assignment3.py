...
def browser_stats(records):
    ...
    print("The most popular browser is {}".format(most_popular))


def hourly_stats(records):
    """
    Extra credit:
    Counts requests by hour and sorts them
